...
static const uint256 hashGenesisBlock("0x000008551c8730d15242a666f5aca99741a2f780c0d9cd2e19c6652fa8e3788b");
static const uint256 hashGenesisBlockTestNet("0x000008551c8730d15242a666f5aca99741a2f780c0d9cd2e19c6652fa8e3788b");
...
public:
    ...
    {
        // RADICAL: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // RADICAL: get transaction coin age
...
public:
    ...
    // RADICAL: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // RADICAL: two types of block: proof-of-work or proof-of-stake
    ...
    // RADICAL: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // RADICAL: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // RADICAL: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // RADICAL: block index flags
    enum  
    {
